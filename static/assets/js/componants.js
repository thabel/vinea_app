function  handle_pagination(){
  ...
  paginationLeftArrow.addEventListener('click', () => {
    setActiveNumber(paginationActiveNumber.parentElement.previousElementSibling.childNodes[1])
    postionIndicator(paginationActiveNumber)
  })

  paginationRightArrow.addEventListener('click', () => {
    setActiveNumber(paginationActiveNumber.parentElement.nextElementSibling.childNodes[1])
    postionIndicator(paginationActiveNumber)
  })
  ...
  postionIndicator(paginationActiveNumber)
    ...
    console.log("hey hey js loading", )

jQuery(document).ready((handle_pagination));